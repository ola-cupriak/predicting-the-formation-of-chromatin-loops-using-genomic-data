"""predicting-the-formation-of-chromatin-loops-using-genomic-data file for ensuring the package is executable
as `predicting-the-formation-of-chromatin-loops-using-genomic-data` and `python -m predicting_the_formation_of_chromatin_loops_using_genomic_data`
"""
import importlib
