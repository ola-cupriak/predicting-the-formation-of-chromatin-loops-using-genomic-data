...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    input_data = (
        fly_neg_sampling_type + ".FLY_concatenated_combined_functional_genomics_data"
    )
    ...
    main_pipeline = pipeline(
        [
            node(
                ...
                inputs=[
                    input_data,
                    "params:fly_features_include_only",
                    "params:fly_features_exclude",
                ],
            ...
            node(
                ...
                inputs=[
                    "fly_read_data",
                    "params:fly_log_reg.type",
                    "params:fly_log_reg.params",
                    "params:fly_log_reg.optimize",
                    "params:fly_log_reg.run",
                    "params:fly_log_reg.cv",
                    "params:random_state",
                    "params:fly_log_reg.optim_time",
                    "params:fly_log_reg.n_trials",
                ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "fly_read_data",
                    "params:fly_rf.type",
                    "params:fly_rf.params",
                    "params:fly_rf.optimize",
                    "params:fly_rf.run",
                    "params:fly_rf.cv",
                    "params:random_state",
                    "params:fly_rf.optim_time",
                    "params:fly_rf.n_trials",
                ],
                outputs=[
            ...
            node(
                ...
                inputs=[
                    "fly_read_data",
                    "params:fly_lgbm.type",
                    "params:fly_lgbm.params",
                    "params:fly_lgbm.optimize",
                    "params:fly_lgbm.run",
                    "params:fly_lgbm.cv",
                    "params:random_state",
                    "params:fly_lgbm.optim_time",
                    "params:fly_lgbm.n_trials",
                ],
            ...
            node(
                ...
                inputs=[
                    "fly_read_data",
                    "params:fly_dt.type",
                    "params:fly_dt.params",
                    "params:fly_dt.optimize",
                    "params:fly_dt.run",
                    "params:fly_dt.cv",
                    "params:random_state",
                    "params:fly_dt.optim_time",
                    "params:fly_dt.n_trials",
                ],
                outputs=[
