...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    main_pipeline = pipeline([
        ...
        node(
         ...
         node(
            func=fly_optimize_parameters,
            inputs=["fly_read_data", "params:dt.type", "params:dt.params", "params:dt.optimize", 
                    "params:dt.run", "params:dt.cv", "params:random_state", "params:dt.optim_time", "params:dt.n_trials"],
        ...
        node(
            ...
            inputs=["fly_read_data", "params:fly_log_reg.type", "FLY_logistic_regression_params", "params:fly_log_reg.run", "params:fly_run_name", "params:fly_neg_sampling_type"],
        ...
        node(
            func=fly_train_and_eval,
            inputs=["fly_read_data", "params:fly_rf.type", "FLY_random_forest_params", "params:fly_rf.run", "params:fly_run_name", "params:fly_neg_sampling_type"],
        ...
        node(
            func=fly_train_and_eval,
            inputs=["fly_read_data", "params:fly_lgbm.type", "FLY_lightgbm_params", "params:fly_lgbm.run", "params:fly_run_name", "params:fly_neg_sampling_type"],
        ...
        node(
            func=fly_train_and_eval,
            inputs=["fly_read_data", "params:fly_xgb.type", "FLY_xgboost_params", "params:fly_xgb.run", "params:fly_run_name", "params:fly_neg_sampling_type"],
        ...
        node(
            func=fly_train_and_eval,
            inputs=["fly_read_data", "params:dt.type", "decision_tree_params", "params:dt.run", "params:fly_run_name", "params:fly_neg_sampling_type"],
