...
from .nodes import read_hic, add_labels, read_peaks, count_peaks, read_bigWig, add_bigWig_data, simplify_genome_file, gather_all_anchors_into_df, getfasta_anchors, anchors2df
...
def create_pipeline(**kwargs) -> Pipeline:
    return pipeline(
        [
            ...
            #     outputs=["hg19_simplified", "path_hg19_simplified"],
            ...
            # node(
            #     func=count_peaks,
            #     inputs=["HiC_loops_anotations_with_CTCF_ChIP_seq_peaks", "readed_DNase_seq_peaks", "anchors_df", "params:DNase-seq_peaks", "params:radius", "path_motifs_JASPAR_vertebrates"],
