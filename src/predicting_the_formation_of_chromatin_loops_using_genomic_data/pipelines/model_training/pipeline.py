...
def create_pipeline(mtype: str, **kwargs) -> Pipeline:
    ...
    if mtype == 'within':
        read_data_input = [input_data, "params:cell_types", "params:type", "params:random_state",
                            "params:features_include_only", "params:features_exclude"]
    elif mtype == 'across':
        read_data_input = [input_data, "params:cell_types", "params:type", "params:random_state",
                            "params:features_include_only", "params:features_exclude", "params:data_fraction"]
    ...
    pipeline_template = pipeline([
        ...
        node(
            ...
            inputs=["split_data", "params:type", "params:log_reg.type", "params:log_reg.params", "params:log_reg.optimize", "params:log_reg.run", "params:test_size", "params:validation_size",
        ...
        node(
            func=optimize_parameters,
            inputs=["split_data", "params:type", "params:rf.type", "params:rf.params", "params:rf.optimize", "params:rf.run", "params:test_size", "params:validation_size",
        ...
        node(
            func=optimize_parameters,
            inputs=["split_data", "params:type", "params:lgbm.type", "params:lgbm.params", "params:lgbm.optimize", "params:lgbm.run", "params:test_size", "params:validation_size",
        ...
        node(
            func=optimize_parameters,
            inputs=["split_data", "params:type", "params:xgb.type", "params:xgb.params", "params:xgb.optimize", "params:xgb.run", "params:test_size", "params:validation_size",
         ...
         node(
            func=optimize_parameters,
            inputs=["split_data", "params:type", "params:dt.type", "params:dt.params", "params:dt.optimize", "params:dt.run", "params:test_size", "params:validation_size",
        ...
        node(
            func=train_and_eval,
            inputs=["split_data", "params:type", "params:log_reg.type", "logistic_regression_params", "params:log_reg.run", "params:run_name", "params:neg_sampling_type"],
        ...
        node(
            func=train_and_eval,
            inputs=["split_data", "params:type", "params:rf.type", "random_forest_params", "params:rf.run", "params:run_name", "params:neg_sampling_type"],
            outputs=["random_forest_models", "random_forest_metrics", "random_forest_confusionmatrix",
                     "random_forest_feature_importance_df", "random_forest_feature_importance_plot"],
            name="train_and_eval_random_forest_node",
        ),
        node(
            func=train_and_eval,
            inputs=["split_data", "params:type", "params:lgbm.type", "lightgbm_params", "params:lgbm.run", "params:run_name", "params:neg_sampling_type"],
        ...
        node(
            func=train_and_eval,
            inputs=["split_data", "params:type", "params:xgb.type", "xgboost_params", "params:xgb.run", "params:run_name", "params:neg_sampling_type"],
        ...
        node(
            func=train_and_eval,
            inputs=["split_data", "params:type", "params:dt.type", "decision_tree_params", "params:dt.run", "params:run_name", "params:neg_sampling_type"],
