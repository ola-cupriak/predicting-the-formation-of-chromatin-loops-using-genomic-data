...
def create_pipeline(neg_sampling_type: str, **kwargs) -> Pipeline:
    ...
    pipeline_template = pipeline([
            node(
                func=fly_read_hic,
                inputs=["FLY_HiC_loops_annoatations", "FLY_cells2names", "params:fly_HiC_data", "params:fly_radius"],
                outputs="FLY_readed_HiC_loops_anotations",
                name="FLY_read_HiC_loops_anotations_node",
            ),
            node(
                func=fly_read_peaks,
                inputs=["FLY_CNS_L3_ATAC_seq_peaks", "FLY_cells2names", "params:CNS_L3_ATAC_seq_peaks"],
                outputs="readed_CNS_L3_ATAC_seq_peaks",
                name="FLY_read_CNS_L3_ATAC_seq_peaks_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_CNS_L3_ATAC_seq_bigWig", "FLY_cells2names", "params:CNS_L3_ATAC_seq_bigWig"],
                outputs="readed_CNS_L3_ATAC_seq_bigWig",
                name="FLY_read_CNS_L3_ATAC_seq_bigWig_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_ATAC_seq_clustered_bigWig", "FLY_cells2names", "params:ATAC_seq_clustered_bigWig"],
                outputs="readed_ATAC_seq_clustered_bigWig",
                name="FLY_read_ATAC_seq_clustered_bigWig_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_DNase_seq_4-6h_bigWig", "FLY_cells2names", "params:DNase_seq_4-6h_bigWig"],
                outputs="readed_DNase_seq_4-6h_bigWig",
                name="read_DNase_seq_4-6h_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_DNase_seq_6-8h_bigWig", "FLY_cells2names", "params:DNase_seq_6-8h_bigWig"],
                outputs="readed_DNase_seq_6-8h_bigWig",
                name="read_DNase_seq_6-8h_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_DNase_seq_8-10h_bigWig", "FLY_cells2names", "params:DNase_seq_8-10h_bigWig"],
                outputs="readed_DNase_seq_8-10h_bigWig",
                name="read_DNase_seq_8-10h_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_DNase_seq_10-12h_bigWig", "FLY_cells2names", "params:DNase_seq_10-12h_bigWig"],
                outputs="readed_DNase_seq_10-12h_bigWig",
                name="read_DNase_seq_10-12h_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Beaf-32_ChIP_seq_bigWig", "FLY_cells2names", "params:Beaf-32_ChIP_seq_bigWig"],
                outputs="readed_Beaf-32_ChIP_seq_bigWig",
                name="read_Beaf-32_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Cap-H2_ChIP_seq_bigWig", "FLY_cells2names", "params:Cap-H2_ChIP_seq_bigWig"],
                outputs="readed_Cap-H2_ChIP_seq_bigWig",
                name="read_Cap-H2_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Chromator_ChIP_seq_bigWig", "FLY_cells2names", "params:Chromator_ChIP_seq_bigWig"],
                outputs="readed_Chromator_ChIP_seq_bigWig",
                name="read_Chromator_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_CP190_ChIP_seq_bigWig", "FLY_cells2names", "params:CP190_ChIP_seq_bigWig"],
                outputs="readed_CP190_ChIP_seq_bigWig",
                name="read_CP190_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_CTCF_ChIP_seq_bigWig", "FLY_cells2names", "params:fly_CTCF_ChIP_seq_bigWig"],
                outputs="FLY_readed_CTCF_ChIP_seq_bigWig",
                name="FLY_read_CTCF_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_GAF_ChIP_seq_bigWig", "FLY_cells2names", "params:GAF_ChIP_seq_bigWig"],
                outputs="readed_GAF_ChIP_seq_bigWig",
                name="read_GAF_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Ibf2_ChIP_seq_bigWig", "FLY_cells2names", "params:Ibf2_ChIP_seq_bigWig"],
                outputs="readed_Ibf2_ChIP_seq_bigWig",
                name="read_Ibf2_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_M1BP_ChIP_seq_bigWig", "FLY_cells2names", "params:M1BP_ChIP_seq_bigWig"],
                outputs="readed_M1BP_ChIP_seq_bigWig",
                name="read_M1BP_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Pita_ChIP_seq_bigWig", "FLY_cells2names", "params:Pita_ChIP_seq_bigWig"],
                outputs="readed_Pita_ChIP_seq_bigWig",
                name="read_Pita_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Rad21_ChIP_seq_bigWig", "FLY_cells2names", "params:Rad21_ChIP_seq_bigWig"],
                outputs="readed_Rad21_ChIP_seq_bigWig",
                name="read_Rad21_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_SuHw_ChIP_seq_bigWig", "FLY_cells2names", "params:SuHw_ChIP_seq_bigWig"],
                outputs="readed_SuHw_ChIP_seq_bigWig",
                name="read_SuHw_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_ZIPIC_ChIP_seq_bigWig", "FLY_cells2names", "params:ZIPIC_ChIP_seq_bigWig"],
                outputs="readed_ZIPIC_ChIP_seq_bigWig",
                name="read_ZIPIC_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_read_bigWig,
                inputs=["FLY_Zw5_ChIP_seq_bigWig", "FLY_cells2names", "params:Zw5_ChIP_seq_bigWig"],
            ...
            node(
                ...
                inputs=["FLY_positive_and_negative_HiC_loops_anotations", "readed_CNS_L3_ATAC_seq_peaks", "params:CNS_L3_ATAC_seq_peaks"],
                outputs="HiC_loops_anotations_with_CNS_L3_ATAC_seq_peaks_data",
                name="add_CNS_L3_ATAC_seq_peaks_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_CNS_L3_ATAC_seq_peaks_data", "readed_CNS_L3_ATAC_seq_bigWig", "params:CNS_L3_ATAC_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_CNS_L3_ATAC_seq_bigWig_data",
                name="add_CNS_L3_ATAC_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_CNS_L3_ATAC_seq_bigWig_data", "readed_ATAC_seq_clustered_bigWig", "params:ATAC_seq_clustered_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_ATAC_seq_clustered_bigWig_data",
                name="add_ATAC_seq_clustered_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_ATAC_seq_clustered_bigWig_data", "readed_DNase_seq_4-6h_bigWig", "params:DNase_seq_4-6h_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_DNase_seq_4-6h_bigWig_data",
                name="add_DNase_seq_4-6h_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_DNase_seq_4-6h_bigWig_data", "readed_DNase_seq_6-8h_bigWig", "params:DNase_seq_6-8h_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_DNase_seq_6-8h_bigWig_data",
                name="add_DNase_seq_6-8h_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_DNase_seq_6-8h_bigWig_data", "readed_DNase_seq_8-10h_bigWig", "params:DNase_seq_8-10h_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_DNase_seq_8-10h_bigWig_data",
                name="add_DNase_seq_8-10h_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_DNase_seq_8-10h_bigWig_data", "readed_DNase_seq_10-12h_bigWig", "params:DNase_seq_10-12h_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_DNase_seq_10-12h_bigWig_data",
                name="add_DNase_seq_10-12h_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_DNase_seq_10-12h_bigWig_data", "readed_Beaf-32_ChIP_seq_bigWig", "params:Beaf-32_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Beaf-32_ChIP_seq_bigWig_data",
                name="add_Beaf-32_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Beaf-32_ChIP_seq_bigWig_data", "readed_Cap-H2_ChIP_seq_bigWig", "params:Cap-H2_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Cap-H2_ChIP_seq_bigWig_data",
                name="add_Cap-H2_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Cap-H2_ChIP_seq_bigWig_data", "readed_Chromator_ChIP_seq_bigWig", "params:Chromator_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Chromator_ChIP_seq_bigWig_data",
                name="add_Chromator_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Chromator_ChIP_seq_bigWig_data", "readed_CP190_ChIP_seq_bigWig", "params:CP190_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_CP190_ChIP_seq_bigWig_data",
                name="add_CP190_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_CP190_ChIP_seq_bigWig_data", "FLY_readed_CTCF_ChIP_seq_bigWig", "params:fly_CTCF_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_FLY_CTCF_ChIP_seq_bigWig_data",
                name="add_FLY_CTCF_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_FLY_CTCF_ChIP_seq_bigWig_data", "readed_GAF_ChIP_seq_bigWig", "params:GAF_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_GAF_ChIP_seq_bigWig_data",
                name="add_GAF_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_GAF_ChIP_seq_bigWig_data", "readed_Ibf2_ChIP_seq_bigWig", "params:Ibf2_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Ibf2_ChIP_seq_bigWig_data",
                name="add_Ibf2_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Ibf2_ChIP_seq_bigWig_data", "readed_M1BP_ChIP_seq_bigWig", "params:M1BP_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_M1BP_ChIP_seq_bigWig_data",
                name="add_M1BP_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_M1BP_ChIP_seq_bigWig_data", "readed_Pita_ChIP_seq_bigWig", "params:Pita_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Pita_ChIP_seq_bigWig_data",
                name="add_Pita_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Pita_ChIP_seq_bigWig_data", "readed_Rad21_ChIP_seq_bigWig", "params:Rad21_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_Rad21_ChIP_seq_bigWig_data",
                name="add_Rad21_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_Rad21_ChIP_seq_bigWig_data", "readed_SuHw_ChIP_seq_bigWig", "params:SuHw_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_SuHw_ChIP_seq_bigWig_data",
                name="add_SuHw_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_SuHw_ChIP_seq_bigWig_data", "readed_ZIPIC_ChIP_seq_bigWig", "params:ZIPIC_ChIP_seq_bigWig", "params:fly_resolution"],
                outputs="HiC_loops_anotations_with_ZIPIC_ChIP_seq_bigWig_data",
                name="add_ZIPIC_ChIP_seq_bigWig_data_node",
            ),
            node(
                func=fly_add_bigWig_data,
                inputs=["HiC_loops_anotations_with_ZIPIC_ChIP_seq_bigWig_data", "readed_Zw5_ChIP_seq_bigWig", "params:Zw5_ChIP_seq_bigWig", "params:fly_resolution"],
    ...
    main_pipeline = pipeline(
        ...
        parameters=[
            ...
            "params:ATAC_seq_clustered_bigWig",
