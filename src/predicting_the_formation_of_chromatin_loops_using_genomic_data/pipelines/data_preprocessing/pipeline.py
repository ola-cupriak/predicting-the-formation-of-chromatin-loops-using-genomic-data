    ...
    pipeline_template = pipeline(
        [
            ...
            node(
                func=add_labels,
                inputs=[
                    "readed_HiC_loops_anotations",
                    "params:type",
                    "readed_DNase_seq_peaks",
                    "params:radius",
                    "params:human_neg_pos_ratio",
                    "params:random_state",
                ],
            ...
            node(
                ...
                inputs=[
                    ...
                    "params:human_path_fasta_anchors_with_open_chromtin",
                ],
            ...
            node(
                ...
                inputs=[
                    ...
                    "human_path_fasta_anchors_with_open_chromtin",
                ],
            ...
            node(
                ...
                inputs=[
                    "positive_and_negative_HiC_loops_anotations",
                    "readed_CTCF_ChIP_seq_peaks",
                    "params:CTCF_ChIP-seq_peaks",
                ],
            ...
            node(
                func=count_peaks_and_distances,
                inputs=[
                    "HiC_loops_anotations_with_CTCF_ChIP_seq_peaks",
                    "readed_DNase_seq_peaks",
                    "params:DNase-seq_peaks",
                ],
            ...
            node(
                ...
                inputs=[
                    "HiC_loops_anotations_with_DNase_seq_peaks",
                    "readed_DNase_seq_bigWig",
                    "params:DNase-seq_bigWig",
                    "params:resolution",
                ],
            ...
            node(
                func=add_bigWig_data,
                inputs=[
                    "HiC_loops_anotations_with_DNase_seq_bigWig_data",
                    "readed_CTCF_ChIP_seq_bigWig",
                    "params:CTCF_ChIP-seq_bigWig",
                    "params:resolution",
                ],
            ...
            node(
                func=count_motifs,
                inputs=[
                    "HiC_loops_anotations_with_CTCF_ChIP_seq_bigWig_data",
